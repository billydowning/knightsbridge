...
const BACKEND_URL = 'https://knightsbridge-app-35xls.ondigitalocean.app/knightsbridge2';
...
async function main() {
  try {
    ...
    console.log('\n🔗 Test URLs:');
    console.log('- Backend Health: https://knightsbridge-app-35xls.ondigitalocean.app/knightsbridge2/health');
    ...
    console.log('5. Try accessing the health endpoint manually: https://knightsbridge-app-35xls.ondigitalocean.app/knightsbridge2/health');
